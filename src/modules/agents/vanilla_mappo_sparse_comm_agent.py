...
class VanillaMAPPOSparseCommAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(VanillaMAPPOSparseCommAgent, self).__init__()
        self.args = args
    ...
    def forward(self, inputs, hidden_state, bs, test_mode=False, **kwargs):
        ...
        if test_mode:
            ...
            if self.comm_eval_renorm:
                # Keep eval-time pruning numerically consistent with the training-time simplex.
