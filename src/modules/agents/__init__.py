...
from .vanilla_mappo_microcomm_dualstream_counterfactual_usegate_agent import VanillaMAPPOMicroCommDualStreamCounterfactualUseGateAgent
...
REGISTRY["vanilla_mappo_microcomm_dualstream_counterfactual_usegate"] = VanillaMAPPOMicroCommDualStreamCounterfactualUseGateAgent
