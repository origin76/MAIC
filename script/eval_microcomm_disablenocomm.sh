...
# Usage:
#   zsh script/eval_microcomm_disablenocomm.sh <alg_config> <checkpoint_dir> [seed] [test_nepisode] [load_step] [env_config]
#
# Example (g2c around 1.2M):
#   zsh script/eval_microcomm_disablenocomm.sh \
...
#     1 1024 1203451 sc2_5m_vs_6m_local
...
python src/main.py --config="${ALG_CONFIG}" --env-config="${ENV_CONFIG}" with \
  ...
  eval_disable_no_comm_token=True
